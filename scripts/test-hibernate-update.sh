...
mvnd -pl extensions/hibernate-reactive/deployment,extensions/hibernate-orm/deployment,extensions/panache/hibernate-reactive-panache-common/deployment,extensions/panache/hibernate-reactive-panache/deployment,extensions/spring-data-jpa/deployment,integration-tests/hibernate-reactive-postgresql,integration-tests/hibernate-reactive-panache,integration-tests/smallrye-context-propagation,integration-tests/devtools verify -Dtest-containers=true
